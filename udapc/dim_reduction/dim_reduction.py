...
from udapc.utils.misc import get_processor_name
...
class DimReduction:
	...
	def plot_xval_accuracy(
		...
		ax = sns.boxplot(x="PCs", y="accuracy", data=xval)
		#plt.show()
		
		ax.set_xlabel("PCs retained")
		
		ax.set_ylabel("% accuracy of assignment")
		
		plot_fn = "{}/xval-accuracy.pdf".format(plot_dir)
		...
		print(
			"\nSaved {} xval accuracy plot to {}".format(
				self.method, plot_dir
			)
		)
	...
	def plot_xval_rmse(
		...
		ax = sns.scatterplot(x="PCs", y="RMSE", data=xval)
		#plt.show()
		...
		plot_fn = "{}/xval-rmse.pdf".format(plot_dir)
		...
		print(
			"\nSaved {} xval RMSE plot to {}".format(
				self.method, plot_dir
			)
		)